...
namespace Donut {
	...
	std::shared_ptr<spdlog::logger> EngineLog::sptr_core_logger_;
	std::shared_ptr<spdlog::logger> EngineLog::sptr_client_logger_;
	...
	std::shared_ptr<spdlog::logger>& EngineLog::getCoreLogger() { return sptr_core_logger_; }
	std::shared_ptr<spdlog::logger>& EngineLog::getClientLogger() { return sptr_client_logger_; }
}
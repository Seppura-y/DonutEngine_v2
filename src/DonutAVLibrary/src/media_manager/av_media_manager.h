#ifndef AV_MEDIA_MANAGER_H
#define AV_MEDIA_MANAGER_H
...
class DONUT_API AVMediaManager
{
public:
	static AVMediaManager* createVideoPlayer(PlayerType type = PlayerType::PLAYER_TYPE_DONUT);
